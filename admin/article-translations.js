(function () {
  ...
  async function act(action) {
    ...
    try {
      const data = await api(action, { ...current, title: byId('translation-title').value, summary: byId('translation-summary').value, content: byId('translation-content').value });
      if (data.translation) { byId('translation-title').value = data.translation.title || ''; byId('translation-summary').value = data.translation.summary || ''; byId('translation-content').value = data.translation.content || ''; }
