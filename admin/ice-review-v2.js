(() => {
  ...
  renderReviewCard = function renderReviewCardV3(story) {
    ...
    const payload = story?.ai_payload && typeof story.ai_payload === "object" ? story.ai_payload : {};
    const count = Array.from(clean(story.final_content || story.content).replace(/\s+/g, "")).length;
