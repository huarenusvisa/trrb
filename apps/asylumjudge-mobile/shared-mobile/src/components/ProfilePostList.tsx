...
const styles = StyleSheet.create({
  list:{gap:12},card:{backgroundColor:'#fff',borderRadius:18,padding:14,borderWidth:1,borderColor:'#dbe6df'},cardHead:{flexDirection:'row',justifyContent:'space-between',alignItems:'center'},time:{fontSize:12,color:'#7b8c82'},delete:{color:'#b42318',fontWeight:'800'},caption:{color:'#203229',fontSize:16,lineHeight:23,marginTop:9,marginBottom:10},mediaSingle:{borderRadius:13,overflow:'hidden',marginTop:10},mediaGrid:{flexDirection:'row',flexWrap:'wrap',gap:4,marginTop:10},image:{width:'100%',aspectRatio:1.25,backgroundColor:'#edf3ef'},video:{width:'100%',aspectRatio:16/10,backgroundColor:'#000'},multiImage:{width:'49%',aspectRatio:1,backgroundColor:'#edf3ef'},empty:{backgroundColor:'#fff',borderRadius:18,padding:28,alignItems:'center',borderWidth:1,borderColor:'#dbe6df'},emptyIcon:{fontSize:28,color:'#8ca096'},emptyTitle:{fontSize:17,fontWeight:'900',color:'#284236',marginTop:8},emptyText:{color:'#748279',marginTop:5,textAlign:'center'}
});
