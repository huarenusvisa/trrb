...
export default function ProfileScreen() {
  return (
    <View style={styles.page}>
      ...
      <Pressable style={styles.item}><Text style={styles.title}>收藏</Text><Text style={styles.meta}>下一阶段接入本地与账号同步</Text></Pressable>
      <Pressable style={styles.item}><Text style={styles.title}>阅读历史</Text><Text style={styles.meta}>下一阶段接入</Text></Pressable>
      <Pressable style={styles.item}><Text style={styles.title}>推送设置</Text><Text style={styles.meta}>重大新闻 · ICE · 移民 · 判例新规</Text></Pressable>
