...
export default function ArticleDetailScreen() {
  ...
  return <><Stack.Screen options={{ title: '新闻详情', headerBackTitle: '返回' }} /><ScrollView style={styles.page} contentContainerStyle={styles.content}>
    ...
    <View style={styles.fontBar}><Text style={styles.fontLabel}>正文字号</Text>{FONT_SCALES.map((scale)=><Pressable key={scale} onPress={async()=>{setFontScale(scale);await setReadingFontScale(scale);}} style={[styles.fontButton,fontScale===scale&&styles.fontButtonActive]}><Text style={[styles.fontButtonText,fontScale===scale&&styles.fontButtonTextActive]}>A</Text></Pressable>)}</View>
