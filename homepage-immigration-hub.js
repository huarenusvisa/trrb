(function () {
  ...
  function judgeMarkup() {
    return `
      <header class="immigration-hub-head legal-hub-head"><h2>移民法官通过率</h2><a href="/immigration-judge-approval-rate/">进入查询</a></header>
      ...
      <div class="immigration-hub-grid legal-hub-grid judge-action-grid">
        ...
        <a href="/immigration-judge-approval-rate/states.html"><strong>各州通过率</strong><span aria-hidden="true">›</span></a>
      </div>
