(() => {
  ...
  headLink('icon', '/favicon.svg?v=20260825', 'image/svg+xml');
  headLink('shortcut icon', '/favicon.ico?v=20260825');
  ...
  style.textContent = '.hw-domain-bar{background:#fff;border-bottom:1px solid #dce6f2}.hw-domain-inner{max-width:1180px;min-height:64px;margin:auto;padding:0 18px;display:flex;align-items:center;gap:18px}.hw-domain-logo{font-weight:900;font-size:20px;color:#0f172a;text-decoration:none;margin-right:auto}.hw-domain-logo img{display:inline-block;width:34px;height:34px;margin-right:8px;vertical-align:middle;filter:drop-shadow(0 4px 8px rgba(230,61,40,.2))}.hw-domain-inner a:not(.hw-domain-logo){color:#1769d2;text-decoration:none;font-size:13px;font-weight:800}@media(max-width:600px){.hw-domain-inner{min-height:57px}.hw-domain-inner a:not(.hw-domain-logo){display:none}}';
  document.head.appendChild(style);
  const bar = document.createElement('div');
  bar.className = 'hw-domain-bar';
  bar.innerHTML = '<div class="hw-domain-inner"><a class="hw-domain-logo" href="/"><img src="/favicon.svg?v=20260825" alt="">华人工作网</a><a href="/jobs/">找工作</a><a href="/jobs/publish.html">发布招聘</a><a href="https://trrb.net/">唐人日报入口</a></div>';
