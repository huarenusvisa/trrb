(function(){
  ...
  const topicBlueprint={
    ...
    i130:['I-130是什么','哪些亲属可以申请','申请人与受益人资格','线上与纸质递交','I-130A适用情形','亲属关系证据','优先日期','USCIS审理与补件','批准后NVC或I-485衔接','撤回、死亡与人道恢复','常见问题'],
    ...
    'u-visa':['U签证是什么','符合条件的犯罪类型','遭受重大身体或精神伤害','掌握犯罪信息','帮助或愿意帮助执法','I-918申请','I-918 Supplement B执法认证','家属衍生申请','不准入豁免I-192','等待名单与递延行动','工卡','年度名额与等待时间','三年后申请绿卡','执法认证被拒怎么办','保密与安全保护','常见问题'],
    't-visa':['T签证是什么','严重形式人口贩运','性交易与强迫劳动','因贩运身处美国','配合执法要求及例外','离境将遭受极端困难','I-914申请','执法机构声明','人口贩运证据','不准入豁免','家属衍生申请','工卡与公共福利','三年后或调查结束后申请绿卡','保密与安全规划','常见问题'],
    sijs:['SIJS是什么','未满21岁且未婚要求','少年法院管辖','遭一方或双方父母虐待、遗弃或忽视','不符合返回原籍国最佳利益','州法院特殊裁定','监护、抚养或监护权案件','I-360申请','优先日期与EB-4排期','I-485调整身份','不能为父母申请身份','工卡与递延行动','年龄保护','州法差异','常见问题'],
    tps:['TPS是什么','指定国家与指定期间','国籍或无国籍身份要求','持续居住与持续实际停留','首次登记与重新登记','I-821申请','I-765工卡','旅行许可','犯罪与安全障碍','TPS不等于绿卡','TPS期间调整或转换身份','指定终止后的影响','迟交登记例外','保存身份与期限证据','常见问题']
  };
  ...
  const topicAliases={
    ...
    i130:['i-130','i130','亲属移民申请','petition for alien relative'],'citizen-spouse':['婚绿','婚姻绿卡','公民配偶','i-130a','同时递交'],f2a:['绿卡配偶','f-2a','表a','表b'],k1:['k-1','未婚妻签证','未婚夫签证','i-129f'],parents:['父母绿卡','公民申请父母','直系亲属'],children:['子女绿卡','公民申请子女','绿卡申请子女'],siblings:['兄弟姐妹绿卡','f4','公民申请兄弟姐妹'],'cr1-ir1':['cr-1','ir-1','配偶移民签证','ds-260','nvc'],'family-preference':['家庭优先','f1','f2b','f3','f4','签证公告','优先日期'],
    asylum:['政治庇护','种族迫害','宗教迫害','国籍迫害','政治观点','特定社会群体','过去迫害','未来迫害','政府保护能力'],'c08-ead':['c08','c-8','庇护工卡','庇护时钟'],'withholding':['防止递解','withholding of removal','禁止递解'],cat:['cat保护','禁止酷刑','convention against torture'],vawa:['家暴绿卡','家暴保护','i-360','自我申请'],'u-visa':['u签证','u visa','i-918','执法认证'],'t-visa':['t签证','t visa','i-914','人口贩运'],sijs:['特殊青少年','特殊移民青少年','少年法院','州法院裁定'],tps:['临时保护身份','temporary protected status','i-821'],'uscis-policy':['uscis政策','uscis表格','移民局新规','表格版本','官方政策动态']
  };
