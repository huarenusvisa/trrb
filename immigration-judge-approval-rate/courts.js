...
function render(list) {
  $('#court-results').innerHTML = list.length ? `
    <div class="crow chead court-crow"><span>法院</span><span>法官</span><span>有效裁决</span><span class="verdict-pass">批准</span><span class="verdict-deny">拒绝</span><span>裁决批准率</span></div>
