...
export default async (request: Request, context: any) => {
  ...
  try {
    ...
    const iceAssets = path === "/us-enforcement" ? '<link rel="stylesheet" href="/topic/ice/tracking-overlay.css?v=20260916-1"><script defer src="/topic/ice/people-count.js?v=20260916-1"></script><script defer src="/topic/ice/tracking-data.js?v=20260916-1"></script><script defer src="/topic/ice/tracking-overlay.js?v=20260916-1"></script>' : '';
