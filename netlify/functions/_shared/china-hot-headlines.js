...
const CHINA_SIGNALS = [
  ...
  "西藏", "宁夏", "新疆", "广州", "深圳", "武汉", "成都", "西安", "杭州", "南京", "苏州", "郑州", "长沙", "合肥", "东莞", "宁波",
  "济南", "青岛", "厦门", "福州", "南昌", "昆明", "贵阳", "海口", "乌鲁木齐", "哈尔滨", "长春", "沈阳", "大连",
  "新华社", "人民日报", "环球时报", "央视", "抖音", "微博", "微信", "小红书", "B站", "哔哩哔哩", "知乎", "快手",
  "知到", "智慧树", "华为", "任正非", "Ren Zhengfei", "腾讯", "百度", "阿里巴巴", "京东", "拼多多", "小米", "比亚迪", "理想汽车", "理想智驾", "高考", "彩礼"
  , "习近平", "李强", "赵乐际", "王沪宁", "蔡奇", "丁薛祥", "李希", "中共", "共产党", "中央政治局", "政治局常委",
  "中央纪委", "中央批示", "国家监委", "纪委监委", "省委", "市委", "县委", "党委", "党政", "官员", "干部", "书记", "市长", "省长",
