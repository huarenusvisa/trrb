...
export const POLITICS_TERMS = ['习近平','習近平','中共中央','中央政治局','政治局常委','中央军委','中央纪委','国家监委','中国国务院','国务院总理','全国人大','全国政协','省委书记','市委书记','中央组织部','中宣部','中共','党内','人事任免'];
export const XI_TERMS = ['习近平','習近平'];
export const POLITICS_VIEWS = {
  leadership: {label:'领导人动态', terms:['习近平','習近平','总书记','常委','总理','主席']},
