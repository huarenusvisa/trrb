...
assert.match(standalone, /site\.css\?v=30/, 'standalone homepage must load the card-focus stylesheet');
assert.match(trrb, /site\.css\?v=29/, 'embedded homepage must load the card-focus stylesheet');
