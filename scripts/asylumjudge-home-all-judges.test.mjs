...
assert.match(standalone, /app-i18n\.js\?v=10[\s\S]*site\.js\?v=36/, 'standalone homepage must load the trend keyboard-navigation assets');
assert.match(trrb, /app-i18n\.js\?v=9[\s\S]*site\.js\?v=35/, 'embedded homepage must load the trend keyboard-navigation assets');
