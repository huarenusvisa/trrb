...
assert.match(standalone, /site\.css\?v=17[\s\S]*site\.js\?v=24/, 'standalone homepage must load the overview-concurrency assets');
assert.match(trrb, /site\.css\?v=16[\s\S]*site\.js\?v=23/, 'embedded homepage must load the overview-concurrency assets');
