...
assert.match(standalone, /app-i18n\.js\?v=9[\s\S]*site\.js\?v=32/, 'standalone homepage must load the concise-trend-status assets');
assert.match(trrb, /app-i18n\.js\?v=8[\s\S]*site\.js\?v=31/, 'embedded homepage must load the concise-trend-status assets');
