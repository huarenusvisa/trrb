...
assert.match(standalone, /app-i18n\.js\?v=10[\s\S]*site\.js\?v=35/, 'standalone homepage must load the interactive trend-point assets');
assert.match(trrb, /app-i18n\.js\?v=9[\s\S]*site\.js\?v=34/, 'embedded homepage must load the interactive trend-point assets');
