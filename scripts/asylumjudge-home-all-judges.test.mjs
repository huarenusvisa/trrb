...
assert.match(standalone, /site\.css\?v=17[\s\S]*site\.js\?v=25/, 'standalone homepage must load the trend-concurrency assets');
assert.match(trrb, /site\.css\?v=16[\s\S]*site\.js\?v=24/, 'embedded homepage must load the trend-concurrency assets');
