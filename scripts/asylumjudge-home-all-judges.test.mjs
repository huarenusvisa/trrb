...
assert.match(standalone, /site\.css\?v=24/, 'standalone homepage must load the touch-target stylesheet');
assert.match(trrb, /site\.css\?v=23/, 'embedded homepage must load the touch-target stylesheet');
