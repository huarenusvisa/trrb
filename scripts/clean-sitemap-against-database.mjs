...
function cleanUrlset(filePath, publishedIds) {
  ...
  return { before: blocks.length, after: kept.length, removed };
}
...
console.log(`[sitemap-clean] sitemap ${sitemapResult.before} -> ${sitemapResult.after}; removed ${sitemapResult.removed}`);
console.log(`[sitemap-clean] news sitemap ${newsResult.before} -> ${newsResult.after}; removed ${newsResult.removed}`);
