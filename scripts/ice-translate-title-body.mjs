  ...
  const response = await request("https://api.openai.com/v1/responses", {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        target.min === 300 ? "为避免中英文空格造成计数偏差，正文请写到340至355个字符。" : "为避免中英文空格造成计数偏差，正文请写到550至750个字符。",
