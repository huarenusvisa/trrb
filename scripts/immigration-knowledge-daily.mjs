...
async function generateBatch(topicName, angles, avoidTitles) {
  ...
  const asylumGuard = topicName === '政治庇护'
    ? '\n政治庇护专用标准：可覆盖庇护基础、I-589、面谈、证据、可信度、移民法庭、BIA和联邦法院案例、C08工卡与庇护时钟、USCIS/EOIR政策及数据解读。每篇必须在正文末尾列出至少一个可核验的美国政府或法院官方来源链接（uscis.gov、justice.gov、govinfo.gov、federalregister.gov或美国联邦法院官方来源）；不得把提案写成已生效规则，不得编造案件、引证、费用、处理时间或通过率。'
    : '';
