...
// Duplicate records are preserved to avoid destructive editorial changes, but only one
// canonical winner may be advertised for indexing from each exact-title/body cluster.
...
check(/live-supabase-v2-dedupe/i.test(sitemap.headers['x-trrb-sitemap']||''),'Sitemap 已启用重复/薄内容治理版本',sitemap.headers['x-trrb-sitemap']||'missing');
